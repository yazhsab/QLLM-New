"""
Python client SDK for Quantum LLM API.
...
logger = logging.getLogger("quantum_llm.client")

class QuantumLLMClient:
    """
    Client for interacting with the Quantum LLM API.
    """
    ...
    def __init__(self, 
        ...
        self.api_key = api_key or os.environ.get("QUANTUM_LLM_API_KEY")
        self.username = username or os.environ.get("QUANTUM_LLM_USERNAME")
        self.password = password or os.environ.get("QUANTUM_LLM_PASSWORD")
        self.token = token or os.environ.get("QUANTUM_LLM_TOKEN")
...
class AsyncQuantumLLMClient(QuantumLLMClient):
    """
    Asynchronous client for interacting with the Quantum LLM API.
    """
