...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("/var/log/qynthra/entrypoint.log", mode='a')
    ]
)
logger = logging.getLogger("qynthra.deployment.entrypoint")

# Create log directory if it doesn't exist
os.makedirs("/var/log/qynthra", exist_ok=True)
...
def start_api_server(host: str = "0.0.0.0", port: int = 8000):
    ...
    try:
        import uvicorn
        from Qynthra.api.api import app
