/**
 * JavaScript client SDK for Qynthra API.
...
class QynthraClient {
   ...
   * @param {string} [options.modelId='qynthra-base-4q'] - Model ID
  ...
  async generateText(options) {
    ...
    const requestData = {
      ...
      model_id: options.modelId || 'qynthra-base-4q',
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { QynthraClient };
} else {
  window.QynthraClient = QynthraClient;
}

// Example usage in browser:
/*
const client = new QynthraClient({
